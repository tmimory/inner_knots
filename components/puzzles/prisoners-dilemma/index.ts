/** Barrel for the prisoner's dilemma screen's parts. */
export { LabeledToggle, type LabeledToggleProps } from "./labeled-toggle";
export { MOVES, OutcomeGrid, type OutcomeGridProps } from "./outcome-grid";
