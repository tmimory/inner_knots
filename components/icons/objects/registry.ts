/**
 * Which component draws which object.
 *
 ...
 *
 * It sits beside the barrel rather than in it so that `ObjectGlyph`, which reads
 * the registry, can be exported from the barrel without the two importing each
 * other. Import either from `@/components/icons/objects`.
 */
